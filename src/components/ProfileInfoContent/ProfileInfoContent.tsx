      ...
      <div className={styles.content}>
        ...
        <div className={styles['info-block']}>
          ...
          <div className={styles['info-card']}>
            <div className={styles.item}>
              ...
              <span>{shippingAddressInfo.country}</span>
            </div>

            <div className={styles.item}>
              <span className={styles.item__name}>City</span>
              <span>{shippingAddressInfo.city}</span>
            </div>

            <div className={styles.item}>
              <span className={styles.item__name}>Street name</span>
              <span>{shippingAddressInfo.streetName}</span>
            </div>

            <div className={styles.item}>
              <span className={styles.item__name}>Postal code</span>
              <span>{shippingAddressInfo.postalCode}</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles['info-block']}>
          ...
          <div className={styles['info-card']}>
            <div className={styles.item}>
              <span className={styles.item__name}>Country</span>
              <span>{billingAddressInfo.country}</span>
            </div>

            <div className={styles.item}>
              <span className={styles.item__name}>City</span>
              <span>{billingAddressInfo.city}</span>
            </div>

            <div className={styles.item}>
              <span className={styles.item__name}>Street name</span>
              <span>{billingAddressInfo.streetName}</span>
            </div>

            <div className={styles.item}>
              <span className={styles.item__name}>Postal code</span>
              <span>{billingAddressInfo.postalCode}</span>
            </div>
          </div>
        </div>
      </div>
